---
title: Features
description: 'All the features module offers you to build apps with Ionic at great speed'
---

## Page routing

Out of the box, you can start building your Ionic application by creating routes within `~/pages` directory. To access the router, you should use `useIonRouter()` rather than `useRouter()` that's auto-imported from `vue-router`.
